package samso.duarte.pp_samso_duarte.metodes;
...
public class Fitxers {
    ...
    // <editor-fold defaultstate="collapsed" desc="MÈTODES IO">
 ...
 */
        ...
        ObjectInputStream in = null;
        try {
            in = new ObjectInputStream(new FileInputStream(arxiu));
...
//            in = null; // i l’alliberem de la memòria
     ...
     * @throws ClassNotFoundException excepció
     */
    public Object cercaObjecteFitxer(String arxiu,
                                     ComparadorObjectes obj) throws
            InterruptedException, IOException, ClassNotFoundException {
        List<Object> lObjs= cercaObjectesFitxer(arxiu, obj);
        if (lObjs==null)
            return null;
        else
            return lObjs.get(0);
    ...
    /**
     * <p>
     * Cerca una quantitat d'objectes al fitxer i retorna una llista amb tots els que coincideixen
     * i retorna aquest objecte si està al fitxer
     * retornarà null si no el troba
     * <p>
     * IMPORTANT!! EL MÈTODE equals HA D'ESTAR REESCRIT EN LA CLASSE DE L'OBJECTE QUE VOLEM ELIMINAR:
     ...
     * @throws ClassNotFoundException excepció
     */
    public List<Object> cercaObjectesFitxer(String arxiu,
                                            ComparadorObjectes obj) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        for (i = 0; i < LObj.size(); i++) {
            ...
            if (objFitxer.equals(obj)) {            // IMPORTANT!! El mètode equals de la classe de l'objecte que volem eliminar
                LObjectesTrobat.add(objFitxer);     // ha d'estar reescrit.
                trobat=true;
            }                               // Mira descripció javadoc del mètode "eliminaRegistreFitxerObjecte".
        }                                   // Hi ha un exemple
        if (!trobat)
            return null;
        else
    ...
    public void eliminaRegistreFitxerObjecte(String fitxer,
        ...
        for (i = 0; i < LObj.size(); i++) {                     // en cas que sols hi hagi 1 element, eliminem l'arxiu
            ...
            }   // final del cas que sols hi hagi 1
        }
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="MÈTODES NIO">
